...
parameter_space = [ 
                    [  5, 0.01, 1e-4], # From best top-k
                    [0.2, 0.01, 1e-4], # From best top-k
                    [ 20, 0.01, 1e-5], # From best top-k
                    [  5,  0.2, 1e-4], # From best acc
                    [ 10,  0.2, 1e-4], # From best acc
                    [0.2,  0.2, 1e-4]  # From best acc
                  ]
