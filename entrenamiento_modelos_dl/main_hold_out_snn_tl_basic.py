...
parameter_space = [[alpha, l2_pen, l_r]
...
# parameter_space = [[alpha, l1_pen, l2_pen, alpha_pen, epsi, trp_sel, l_r]
#                    for alpha in alpha_margins
#                        for l1_pen in l1_penalizers
#                            for l2_pen in l2_penalizers
...
exp_results = expResults.get_results_from_disk(results_snntlbasic_hold_out_file_path,
                                               size_pos_test,
                                               size_neg_test,
                                               face_db_size)
    

for alpha_margin, l2_penalizer, learn_rate in parameter_space:

    # Model parameters
    parameters_used = "SNNTLBASIC." + \
    ...
    print("\nSNNTLBASIC", alpha_margin, l2_penalizer, learn_rate, flush=True)
    ...
    expResults.save_results_to_disk(exp_results, results_snntlbasic_hold_out_file_path)